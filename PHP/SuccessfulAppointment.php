...
<nav>
    ...
    <div class="form-content"style = "margin-top: 70px; width: fit-content; box-shadow: 0px 0px 6px rgba(19, 114, 25, 0.66); border-color: rgb(14, 142, 25); min-width: 100px; max-width: 600px;">
        <div class="form-header" style = "background-color: rgb(14, 142, 25); border-bottom: 10px double white; ">
            <i style = "font-size: 3em; margin-top: 20px;" class="fa-solid fa-circle-check"></i>
            <h1>Appointment Request Sent Successfully!</h1>
        </div>

        <div style = "padding:30px;">
        <p class = "subtext" style = "font-size: 1em; font-weight:bold; text-align: center; color: rgba(0, 0, 0, 0.43)">In a short time, one of our ATU Career Path associates will be in contact with you in reference to your appointment request. Though we cannot guarantee your requested time slot, we will try our best to be flexible for your schedule. You'll be hearing from us soon!</p>
